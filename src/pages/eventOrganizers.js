...
// Data
import eventOrganizersTableData from "layouts/tables/data/eventOrganizersTableData";
                    ...
                    <Grid item xs={12}>
                        <Card>
                            ...
                            {isLoading ? (
                                ...
                                <DataNotFound message={'No Event Organizers Availabale !'} image={noUserImage} />
                            )}
                        </Card>
                    </Grid>
                </Grid>
