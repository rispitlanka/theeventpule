                    ...
                    {ticketData.length > 0 && (
                        <>
                                            ...
                                            <Card sx={{
                                                ...
                                                <Box display="flex" alignItems='center' mt={1}>
                                                    ...
                                                    <MDTypography variant='h5' sx={{ fontSize: { xs: '1rem', md: '1.5rem' } }}>
                                                        {ticketData[0]?.events?.name} at {formattedTime(ticketData[0]?.events?.startTime)}
                                                    </MDTypography>
                                                </Box>
                                                <Box display="flex" alignItems='center' mt={1}>
                            ...
                            <Box mt={3} sx={{ display: 'flex', justifyContent: 'center', gap: 2 }}>
                                ...
                                <MDButton color='primary' variant='contained' disabled={!ticketData[0]?.isActive}>Print Ticket</MDButton>
                            </Box>
                        </>
                    )}
                </>
